...
def order_crossover(parent_a: list, parent_b: list) -> tuple:
            ...
            for r2_idx, r2 in enumerate(routes):
                ...
                for i in range(1, len(r1) - 1):
                    ...
                    for j in range(1, len(r2)):
                        rem_cost = (
                            distance_matrix[r1[i - 1]][r1[i]]
                            + distance_matrix[r1[i]][r1[i + 1]]
                            - distance_matrix[r1[i - 1]][r1[i + 1]]
                        )
                        ins_cost = (
                            distance_matrix[r2[j - 1]][customer]
                            + distance_matrix[customer][r2[j]]
